 ...
 <template>
  <div class="about">
    ...
    <div class="about-body">
      ...
      <div>项目是一套类电商二手书商品系统，包括二手书商品的发布、购买、交易等功能。系统分为用户端和管理员端。</div>
      <div>**用户端：用户可以注册账号、登录系统、搜索二手书商品、购买二手书商品、查看订单、等功能。</div>
      <div>**管理员端：管理员可以登录系统，对二手书商品进行管理、对订单进行管理、对用户进行管理、对分类进行管理、对设置进行管理。</div>
